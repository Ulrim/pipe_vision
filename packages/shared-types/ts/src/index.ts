/**
 * AIVIS shared types — TypeScript mirror of packages/shared-types/python/aivis_types.
 *
 * Single source of truth for the frontend (apps/hmi, apps/dashboard).
 * Field names and types MUST stay 1:1 with the pydantic models. See CLAUDE.md §7.
 *
 * Datetime fields are ISO-8601 strings over the wire (FastAPI serializes
 * pydantic `datetime` to ISO strings). `date` fields are "YYYY-MM-DD".
 */
